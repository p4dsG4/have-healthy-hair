...
from Resize_source import resize_source
...
def main(args):
    ...
    resize_source(args.resize_source) #resize 먼저
    #sys.exit("종료") ###
...
if __name__ == "__main__":
    ...
    # resize
    parser.add_argument('--resize_source', help='Target image')
    ...
    parser.add_argument('--ckpt', type=str, default="hairline/pretrained_models/ffhq.pt") # 경로 수정 1130 sh10hsw
    ...
    parser.add_argument('--seg_ckpt', type=str, default='hairline/pretrained_models/seg.pth') # 경로 수정 1130 sh10hsw
    ...
    parser.add_argument('--W_steps', type=int, default=55, help='Number of W space optimization steps')
    parser.add_argument('--FS_steps', type=int, default=13, help='Number of W space optimization steps')
    ...
    parser.add_argument('--align_steps2', type=int, default=5, help='')
    parser.add_argument('--warp_steps', type=int, default=5, help='')
    ...
    parser.add_argument('--blend_steps', type=int, default=20, help='')
